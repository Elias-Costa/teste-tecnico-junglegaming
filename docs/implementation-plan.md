...
> `bun run check` = typecheck limpo, lint limpo, **305 unitários verdes**. `bun run check:full` = mais **195 de integração** e **11 de concorrência**, autoprovisionados.
> **Etapa atual: E-16 — TESTES DE RECUPERAÇÃO E INVARIANTE FINAL (dia 3).** Nenhuma decisão em aberto; nenhuma etapa bloqueada.
>
